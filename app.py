...
studentOrganisationDetails = {"John Doe": "Women Who Code", "Jane Doe": "Women Who Code", "Jackson Doe": "Charlotte Hack",
 "Lorna Doe": "Charlotte Hack", "Liam Doe": "Charlotte Hack"}
...
def checkNumber():
    ...
    if number == "":
        return render_template('result.html', message="No number provided")
    elif number.isdigit():
        if int(number) % 2 == 0:
            return render_template('result.html', message="Number " + number + " is even")
        else:
            return render_template('result.html', message="Number " + number + " is odd")
    else:
        return render_template('result.html', message="Provided input is not an integer!")
